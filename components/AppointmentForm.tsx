                ...
                >
                    <div className="p-8 text-center bg-gradient-to-br from-brand-50 to-white">
                        ...
                        <a 
                            ...
                            className="flex items-center justify-center w-full bg-[#25D366] text-white px-6 py-4 rounded-xl hover:bg-[#128C7E] font-bold shadow-lg shadow-[#25D366]/30 transition-all text-lg transform hover:scale-105"
                        >
