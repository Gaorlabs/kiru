...
export const Odontogram: React.FC<OdontogramProps> = ({ odontogramState, onToothClick, activeToothInfo, quadrants }) => {
    return (
        <div className="flex flex-col items-center p-2">
            <div className="flex border-b-2 border-slate-300 dark:border-slate-600 w-full justify-center gap-y-2">
                <Quadrant toothIds={quadrants.UPPER_RIGHT.slice().reverse()} odontogramState={odontogramState} onToothClick={onToothClick} activeToothInfo={activeToothInfo} className="border-r-2 border-slate-300 dark:border-slate-600 pr-1" />
            ...
            <div className="flex w-full justify-center pt-2 gap-y-2">
                <Quadrant toothIds={quadrants.LOWER_RIGHT.slice().reverse()} odontogramState={odontogramState} onToothClick={onToothClick} activeToothInfo={activeToothInfo} className="border-r-2 border-slate-300 dark:border-slate-600 pr-1" />
